...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "A 504-506, Navratna Corporate Park, Ambli-Bopal Road, Ahmedabad 380058",
  },
  {
    icon: faEnvelope,
    title: "Email",
    description: "sales@glidemtech.com",
  },
  {
    icon: faPhone,
    title: "Call Us",
    description: "+91 79 29999311",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                We are your trusted partners in product engineering. Reach out to us to bring your ideas to life.
              </p>
            </div>
